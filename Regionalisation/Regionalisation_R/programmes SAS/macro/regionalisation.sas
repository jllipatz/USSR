/**
*
*	Macro qui régionalise les données en fonction des valeurs de clap<br/>
*		elle calcule un ratio dom/france pour chaque siren dont un etab est present dans le dom<br/>
*		par défaut ce ratio vaut : taux=masse salariale dom / masse salariale  france entiere, mais il y a des cas particuliers<br/>
*<br/>				cas 1		:	pas de redressement ; ie toutes les donnees sont presentes => on applique ce taux calculé 
...
*<br/>				cas 12		:	taux=1 car absent du fichier clap (sera mis a  12 par un process ulterieur mais est stocké dej dans le format
...
*<br/>				cas 31		: 	taux corrigé car reventillé sur les autres DFA (1 cas 30 sur les  3 DFAs)
*<br/>				cas 40		: 	taux fixé par fichier externe xls
*
*		<p>la macro s'utilise comme une procédure exemple : </p>
...
*				Va construire la table work.resultat qui contient pour chaque entreprise son "taux de régionalisation" par DFA, <br/>
*				calculé a partir des masses salariales des tables clap.entrep et clap.etab, le tout forcé par le fichier clap.xls
*			</ul>
*
*	@param	libsrc		libname ou se trouve les tables clap
*	@param	tabent		nom de la table qui contient les données entreprises
*	@param	tabetab		nom de la table qui contient les données établissements
*	@param	libcible	libname de la table ou stocker la table de régionalisation
*	@param	tabcible	nom de la table de régionalisation
*	@param	fichierxls	chemin complet du fichier xls comprenant la feuille "regio" fixant une répartition pour un siren (si vide - par defaut- pas de forcage)
*	
*
*	@return 	la table libcible.tabcible qui contient pour chaque sirenXcodep un ratio de repartitions des valeurs d'intérets
*
*
*/
