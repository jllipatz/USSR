...
On s'intéresse ici à comment sélectionner un champ de variables dans une base de données.
C'est-à-dire, quel est le verbe clé dans le logiciel R pour sélectionner certaines variables d'une base de données.
On suppose dans les exemples que les variables sont les colonnes de la base de données.
...
Le premier argument entre crochets correspond à la ligne et le second à la colonne.
Si le premier argument est laissé à blanc, cela correspond à la totalité des lignes.
