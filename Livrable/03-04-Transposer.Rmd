...
Mais on peut aussi se placer du point de vue de la collecte : à chaque date on a observé un certain nombre de communes. A chaque date de collecte correspond alors un ensemble de variables contenant les données pour les différentes communes.
```{r echo=FALSE}
