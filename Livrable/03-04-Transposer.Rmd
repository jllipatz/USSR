...
Dans l'environnement tidyverse, le package **tidyr** offre les fonctionnalité souhaitées par le biais de deux fonctions : `gather` qui permet de passer dans le format pivot (ou "long") et `spread`qui permet de reconstituer le format tabulaire claissique (ou "large").
