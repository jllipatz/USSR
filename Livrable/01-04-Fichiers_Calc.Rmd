...
Le package `readODS` n'est pas recommandé. La fonction `read_ods` de ce package permet de lire un fichier au format **ods**. La fonction `write_ods` ne fonctionne pas. De plus, le développement et la maintenance du package semblent interrompus : la dernière mis à jour remonte à fin 2016. 
