...
test <- read.xlsx(xlsxFile = "writeXLSX1.xlsx",detectDates = TRUE)
...
writeData(wb, sheet = "writeDataTable", df, startRow = 16, startCol = 10, headerStyle = hs1,
          borders = "rows", borderStyle = "medium")



addWorksheet(wb,"Graphiques")
...
insertPlot(wb, sheet = "Graphiques", xy = c("J", 3))
...
# IV.1. Import des données
#-------------------------


test <- read_ods("testCalc.ods")

write_ods(test,path = "../zz.ods")
